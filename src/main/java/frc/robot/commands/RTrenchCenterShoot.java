...
public class RTrenchCenterShoot extends SequentialCommandGroup {
  DriveBase m_driveBase;
  Intake m_intake;
  Shooter m_shooter;
  Indexer m_indexer;

  /** Creates a new RTrenchCenterShoot.
   *  Starts at right trench, collects in center, goes back and shoots
   */
  public RTrenchCenterShoot(DriveBase driveBase, Intake intake, Shooter shooter, Indexer indexer) {
